...
window.onload = function() {
    ...
    var controlLinks = document.querySelector("a.control");
...
function noir(pos, r, g, b, data) {
    var brightness = (3 * r + 3 * g + b) >>> 3;
    if (brightness < 0) brightness = 0;
    data[pos * 4] = brightness;
...
function western(pos, r, g, b, data) {
    ...
    data[pos * 4] = brightness + 40;
    data[pos * 4 + 1] = brightness + 20;
    data[pos * 4 + 2] = brightness - 10;
    data[pos * 4 + 3] = 255;
}
...
function pushUnpushButtons(idToPush, idArrayToUnpush) {
    if (idToPush != "") {
        ...
        if (!theClass.indexOf("selected") >= 0) {
            ...
            anchor.style.backgroundImage = "url(images/" + idToPush + "pressed.png";
        }
    }
